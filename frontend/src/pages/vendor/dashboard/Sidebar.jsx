...
const Sidebar = ({ activeTab, onTabChange, isOpen, onClose, shopName = "VendorHub" }) => {
      ...
      `}>
        ...
        <div className="flex-1 overflow-y-auto py-6 px-3 scrollbar-thin scrollbar-thumb-gray-200 hover:scrollbar-thumb-gray-300">
          <nav className="space-y-1">
            ...
            <SidebarSection title="Catalog Management">
              <SidebarItem icon={Package} label="All Products" id="products" activeTab={activeTab} onTabChange={handleTabChange} />
            ...
            <SidebarSection title="Sales & Orders">
