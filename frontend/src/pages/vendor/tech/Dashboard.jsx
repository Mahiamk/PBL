...
import FeaturedProductManager from './FeaturedProduct';
    ...
    switch(activeTab) {
      ...
      default: {
        ...
        const realProductBreakdown = (() => {
          ...
          return breakdown.length > 0 ? breakdown : [{ label: 'Store Catalog', value: 1 }];
        })();
        ...
        return (
            ...
            <div className="grid grid-cols-1 md:grid-cols-3 gap-5 mb-8">
              <div className="bg-white p-5 rounded-3xl shadow-xs border border-[#e8e8ed] flex items-center justify-between">
                <div>
                  ...
                  <span className="text-[11px] font-semibold text-emerald-600">Hardware & Parts</span>
                </div>
            ...
            <div className="grid grid-cols-1 lg:grid-cols-12 gap-6 mb-8">
              <div className="lg:col-span-7">
                <D3AreaTrendChart
                  ...
                  xKey="date"
                  yKey="total"
                  title="Tech Hub Revenue Stream"
                  subtitle="7-day repair & parts volume (RM)"
                  height={280}
                  color="#1d1d1f"
                />
              </div>
              ...
              <div className="lg:col-span-5">
                <D3DonutBreakdownChart
                  ...
                  subtitle="Active products & component groups"
                  height={280}
                />
              </div>
            </div>
          ...
          <div className="bg-white p-6 rounded-3xl border border-[#e8e8ed] shadow-xs">
            <div className="flex justify-between items-center mb-6">
              <div>
                <h3 className="text-base font-bold text-[#1d1d1f]">Catalog Items & Stock</h3>
                <p className="text-xs text-[#6e6e73]">Tech products and replacement parts inventory.</p>
              </div>
                ...
                <tbody className="divide-y divide-[#f0eaed]">
                  {data.products.slice(0, 5).map((product) => (
                    <tr key={product.product_id} className="hover:bg-[#fbfbfd]">
                      ...
                      <td className="p-3.5 text-[#1d1d1f] font-semibold">{product.stock_quantity || 20} in stock</td>
