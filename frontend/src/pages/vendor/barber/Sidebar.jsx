      ...
      `}>
        <div>
          ...
          <div className={`overflow-y-auto ${isCollapsed ? 'py-3 px-2' : 'py-5 px-3'} max-h-[calc(100vh-140px)] space-y-1`}>
            <SidebarSection title="Quick Links" isCollapsed={isCollapsed}>
            ...
            <SidebarSection title="Studio Services" isCollapsed={isCollapsed}>
              <SidebarItem icon={CalendarCheck} label="Client Appointments" id="appointments" activeTab={activeTab} onTabChange={handleTabChange} isCollapsed={isCollapsed} />
              <SidebarItem icon={Scissors} label="Menu & Pricing" id="services" activeTab={activeTab} onTabChange={handleTabChange} isCollapsed={isCollapsed} />
          ...
          {!isCollapsed ? (
            ...
            <>
              <div 
                ...
                title={`${user?.firstName || user?.name || 'Barber'} (${user?.email || ''})`}
              >
                {user?.firstName?.[0] || user?.name?.[0] || 'B'}
              </div>
              <button 
